...
class UpdateModal extends Component{
    ...
    static getDerivedStateFromProps(props, current_state){
        ...
        if(current_state.employeeSalary && (current_state.employeeSalary !== props.employeeData.employeeSalary ||
            current_state.employeeSalary === props.employeeData.employeeSalary)){
            return null;
        }
    ...
    render(){
        return( 
            ...
            <div className="modal-dialog">
                ...
                <div className="modal-body">
                    <form className="form">
                        <div className="form-group">
                            <input type="text" id="employeeName" className="form-control mb-3" value={this.state.employeeName ?? ""} 
                            onChange={this.inputEmployeeName} />
                        </div>
                        <div className="form-group">
                            <input type="text" id="employeeSalary" className="form-control mb-3" value={this.state.employeeSalary ?? ""}
                ...
                <input type='submit' className='btn btn-info' value="Update" onClick={this.updateEmployeeData}></input>
